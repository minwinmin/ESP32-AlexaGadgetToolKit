...
const char *AmazonId = "xxxx";
const char *AlexaGadgetSecret = "xxxx";
const char *EndpointId = "xxxx";
const char *FriendlyName ="xxxx";
const char *DeviceToken = "xxxx";
const char *FirmwareVersion = "xxxx";
const char *ModelName = "xxxx";
const char *RadioAddress = "xxxx";
